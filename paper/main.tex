...
Justification: The LLM sentinel is evaluated over $n=3$ independent runs with different random seeds. Table~3 footnote reports that LLM results are averaged over 3 evaluation runs. The standard deviation in LP-to-HODL across the 3 runs is 0.020 (1.5\% relative), confirming reasonable stability.
